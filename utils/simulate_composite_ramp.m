...
function [simSignal, burstTrials] = simulate_composite_ramp(fRate, Nsim, np_fs, cW, w_t, burstFR, f_burst)

    deltaF = fRate(end)-fRate(1);
    f_poisson = (1-f_burst*(burstFR-fRate(1)))/(1-f_burst*(fRate(end)-fRate(1)));
